...
struct ScenarioBrain {
    let scenarioArray =  [
        ...
        Scenario(question: "You're unemployed and enjoying the freedom. To collect unemployment, you are expected to look for a job. Do you take the money if you're not?", previouslyDisplayed: false),
        ...
        Scenario(question: "You apply for a job as a junior software developer. The company you're applying for gives you a take-home coding challenge. You are struggling with it. Do you use chatGPT to complete it?", previouslyDisplayed: false),
        ...
        Scenario(question: "Your employer is making you pronouns mandatory in your email signature. Do you oppose?", previouslyDisplayed: false),
        ...
        Scenario(question: "You witness a group of teenagers vandalizing public property in your neighborhood. Do you intervene and try to stop them or report the incident to the authorities?", previouslyDisplayed: false),
        Scenario(question: "You discover that your partner has been secretly going through your phone and social media accounts. Do you confront them about the breach of privacy or just update your passwords?", previouslyDisplayed: false),
        ...
        Scenario(question: "You witness your neighbor leaving their pet alone in their backyard for extended periods without food or water. Do you confront them?", previouslyDisplayed: false),
        Scenario(question: "You find out that your favorite local restaurant has been serving expired food. Do you inform the health department about the violation?", previouslyDisplayed: false),
        ...
        Scenario(question: "You find out that your colleague has been spreading false rumors about another coworker to tarnish their reputation. Do you confront them?", previouslyDisplayed: false),
        ...
        Scenario(question: "You witness a homeless man harassing someone on public transportation. Do you intervene?", previouslyDisplayed: false),
        Scenario(question: "Your friend asks you to borrow a significant amount of money, but you have doubts about their ability to repay it. Do you lend them the money and risk damaging the friendship?", previouslyDisplayed: false),
        ...
        Scenario(question: "You find out that your child has been playfully teasing other students at school. Do you confront them about their behavior?", previouslyDisplayed: false),
        Scenario(question: "Your boss asks you to manipulate financial records to hide company losses. Do you comply with their request?", previouslyDisplayed: false),
        ...
        Scenario(question: "You notice your elderly neighbour has been using your WiFi for simple tasks such as online banking and emails. Do you change the WiFi password?", previouslyDisplayed: false),
        Scenario(question: "Your friend has a drug problem and is offering to pay you $500 dollars for a prescription you don't use. Do you take them up on their offer?", previouslyDisplayed: false),
        Scenario(question: "Your boss keeps stealing your bottle of iced tea from the staff kitchen. Do you confront them or let it slide?", previouslyDisplayed: false),
    ]
}
