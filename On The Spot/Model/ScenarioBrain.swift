...
struct ScenarioBrain {
    let scenarioArray =  [
        ...
        Scenario(question: "You are not physically ill, but emotionally, you're exhausted. Do you call in sick to work?"),
        ...
        Scenario(question: "Your electric scooter was stolen. You are shown a similar one that is not yours at the police station. Do you claim it?"),
        Scenario(question: "After looking for work for 6 months, you get a good offer from a large tabacco maker, which isn not in your field of interest. Do you accept it?"),
        Scenario(question: "You have just started a 6 month contract job when you are offered an excellent permanent position elsewhere IF you begin immediately. Do you break your contract?"),
        Scenario(question: "Your company offers you a $3,000 annual bonus. You have a new job lined up in January, do you still accept the bonus right before leaving?"),
        Scenario(question: "You are waiting at a redlight at 2 a.m. There is nobody around, do you run the light?"),
        Scenario(question: "You are eating at a fast food establishment when you notice a cook drop a bun and then pick it and put it in a takeout bag. Do you voice your concern?"),
        Scenario(question: "You apply for a job as a junior software developer. The company you're applying for gives you a take-home coding challenge, do you use chatGPT to complete it?"),
